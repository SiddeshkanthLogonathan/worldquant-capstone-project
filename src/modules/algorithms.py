...
from .architectures import MultiPeriodEIIE
...
class PolicyGradient:
    ...
    def _setup_train(self, env, policy, batch_size, lr, optimizer):
        ...
        self.train_pvm = PVM(self.train_env.episode_length, env.portfolio_size, multi_period_horizon=self.multi_period_horizon)
    ...
    def _setup_test(self, env, policy, batch_size, lr, optimizer):
        ...
        self.test_pvm = PVM(self.test_env.episode_length, env.portfolio_size, multi_period_horizon=self.multi_period_horizon)
    ...
    def _gradient_ascent(self, test=False):
        ...
        trf_mu = trf_mu.unsqueeze(2).to(self.device)
